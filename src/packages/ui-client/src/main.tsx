/**
 * Application entry point for the kvm-client Tauri UI.
 *
 ...
 * - Deprecated lifecycle methods and APIs trigger warnings.
 ...
 * acknowledges that we are intentionally overriding the null-safety check here.
 */
